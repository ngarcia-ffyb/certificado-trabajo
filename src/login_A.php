...
if (isset($_SESSION['loggedinA']) && $_SESSION['loggedinA'] === true) {
    header('Location: listar_certificados.php');
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    */
    ...
    $sql = "SELECT mdp_personas.apellido,
                   ...
                   mdp_personas.clave
            FROM   negocio.mdp_personas_grupo_acc,
                   negocio.mdp_personas
            WHERE  mdp_personas_grupo_acc.persona = mdp_personas.persona AND
                   mdp_personas.usuario = :username AND
                   (mdp_personas_grupo_acc.usuario_grupo_acc = '10' OR mdp_personas_grupo_acc.usuario_grupo_acc = 'admin') AND
