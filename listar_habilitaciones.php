...
.form-group {
    ...
    min-width: 100px; /* Evita que los campos se hagan demasiado pequeños */
}
...
function guardarHabilitacion() {
    ...
    $.ajax('guardar_ddjj_head.php', {
        ...
        dataType:'json',    
        data: { agnio:  $('#agnio').val(), periodo: $('#periodo').val(), desde: $('#desde').val(), hasta: $('#hasta').val(), estado: $('#estado').val(), finestado: $('#finestado').val()},  // data to submit
